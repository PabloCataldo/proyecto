...
if (isset($_POST['enviar'])) {
  ...
  //******************DEFINIMOS la variable sql para insertar los datos ******************************************************************************
           $sql = "INSERT INTO funcionarios( nombre, cargo, imagen, instagram, facebook, fecha_add) 
                    VALUES (:nombre, :cargo, :imagen, :instagram, :facebook, NOW())"; //NOW  es funcion sql que captura la hora y fecha actual
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="funcionario.php">Funcionarios</a></li>
